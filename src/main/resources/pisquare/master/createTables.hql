...
CREATE EXTERNAL TABLE IF NOT EXISTS shp_md_yssrprod_attr_all (
  ...
  bic_zsdedvno STRING,
  bic_zsdedvuan STRING,
  bic_zsdem7101 STRING,
  bic_zsdem7102 STRING,
  bic_zsdem7103 STRING,
  bic_zsdem7104 STRING,
  bic_zsdemspar STRING,
  bic_zsdemw101 STRING,
  bic_zsdemw102 STRING,
  bic_zsdemw201 STRING,
