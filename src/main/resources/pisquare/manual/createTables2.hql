...
CREATE EXTERNAL TABLE IF NOT EXISTS entity_trades_physical (
  ...
  se_curity_rating_s_p STRING COMMENT 'Security rating� S&P',
  se_curity_rating_moody_s STRING COMMENT 'Security rating� Moody s',
  se_curity_rating_fitch STRING COMMENT 'Security rating� Fitch',
...
CREATE EXTERNAL TABLE IF NOT EXISTS sophis (
  ...
  counterparty_valuation_in_local_currency BIGINT COMMENT 'Counterparty valuation in local currency',
