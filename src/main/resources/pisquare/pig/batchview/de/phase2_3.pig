...
T47 = FOREACH resf GENERATE *, T0_cubea_amount_in_val_crcy AS amount, (T0_cubea_amount_in_val_crcy/fru_fx_rate_used) AS amount_euro,  (T8_ziasde006_additive_margin) AS spread;
...
STORE resfinal INTO '$phase4_repertoir' USING PigStorage('|');
